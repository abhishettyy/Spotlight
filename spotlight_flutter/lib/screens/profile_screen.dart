        ...
        return AlertDialog(
          ...
          title: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.dns_outlined, color: cs.primary, size: 20),
              ),
              const SizedBox(width: 12),
              Text(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  'Configure the API server base URL. Leave empty to restore default.',
                  style: GoogleFonts.inter(
                    fontSize: 14,
                ...
                TextField(
                  ...
                  style: GoogleFonts.inter(color: cs.onBackground),
                  decoration: InputDecoration(
                    hintText: 'e.g. 192.168.1.10:5000/api',
                    hintStyle: GoogleFonts.inter(
                      color: (isDark ? const Color(0xFFA0A0A0) : Colors.grey[500]!).withOpacity(0.6),
                    ),
                    filled: true,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                await ApiService.updateBaseUrl(controller.text);
                if (dialogContext.mounted) {
                  Navigator.pop(dialogContext);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('API Base URL updated to: ${ApiService.baseUrl}'),
                      backgroundColor: cs.primary,
          ...
          child: Column(
            ...
            children: [
              ...
              _buildListTile(
                ...
                Icons.dns_outlined,
                'Server IP / API URL',
                trailingText: ApiService.baseUrl.replaceAll('http://', '').replaceAll('/api', '').replaceAll('/', ''),
                tileColor: tileColor,
